<x-app-layout>
    <div class="space-y-6">
        ...
        @if(isset($deadline) && $deadline)
            <div class="bg-blue-50 border-l-4 border-blue-500 text-blue-700 rounded-lg p-3 text-sm">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div class="dashboard-card bg-green-50 rounded-xl p-4 text-center border border-green-200">
                <p class="text-3xl font-bold text-green-700">{{ $summary['present'] }}</p>
                <p class="text-sm text-green-600">✅ Present</p>
            </div>
            <div class="dashboard-card bg-yellow-50 rounded-xl p-4 text-center border border-yellow-200">
                <p class="text-3xl font-bold text-yellow-700">{{ $summary['permission'] }}</p>
                <p class="text-sm text-yellow-600">📝 Permission</p>
            </div>
            <div class="dashboard-card bg-orange-50 rounded-xl p-4 text-center border border-orange-200">
                <p class="text-3xl font-bold text-orange-700">{{ $summary['sick'] }}</p>
                <p class="text-sm text-orange-600">🤒 Sick</p>
            </div>
            <div class="dashboard-card bg-red-50 rounded-xl p-4 text-center border border-red-200">
