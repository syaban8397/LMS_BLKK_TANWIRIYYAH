<x-app-layout>
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-slate-500 mt-1">
                    Add a new assignment to {{ $class->title }}
                </p>
    ...
    <div class="max-w-7xl mx-auto px-4 py-6">
        ...
        <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-8">
            ...
            <form action="{{ route('instruktur.assignments.store', $class) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            name="title"
                            placeholder="Example: Essay on Web Development"
                            required
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            required
                            class="w-full rounded-2xl border-slate-200 focus:border-blue-500 focus:ring-blue-500 transition shadow-sm px-4 py-3 text-slate-700"></textarea>
