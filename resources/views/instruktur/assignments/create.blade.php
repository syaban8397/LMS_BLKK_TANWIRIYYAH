...
<div class="create-assignment-wrapper lms-module-shell space-y-6">
        <x-lms-page-header
            ...
            :breadcrumbs="[
                ...
                ['label' => __('lms.assignment.create')],
            ]"
        />
        ...
        <x-lms-form-card>
            <form action="{{ route('instruktur.assignments.store', $class) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" placeholder="{{ __('lms.assignment.title_ph') }}" required
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" rows="5" placeholder="{{ __('lms.assignment.desc_ph') }}" required
                ...
                <div class="form-group">
                    ...
                    <div class="upload-area relative border-2 border-dashed border-slate-300 rounded-lg hover:border-blue-400 transition cursor-pointer bg-slate-50/50">
                        ...
                        <div class="text-center py-6 px-4">
                            ...
                            <p class="text-sm text-slate-500">{{ __('lms.assignment.upload_hint') }}</p>
                ...
                <div class="form-group">
                    ...
                    <p class="text-xs text-slate-400 mt-1">{{ __('lms.assignment.deadline_extend_hint') }}</p>
                </div>
                ...
                <div class="bg-blue-50 rounded-xl p-4 border border-blue-200">
                    <div class="flex items-start gap-2">
                        ...
                        <div>
                            <p class="text-sm font-semibold text-blue-800">{{ __('lms.assignment.info_title') }}</p>
                            <p class="text-xs text-blue-700 mt-1">
                                {{ __('lms.assignment.info_change_anytime') }}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <x-lms-form-actions>
                    ...
                    <x-ds.button type="submit" variant="primary">{{ __('lms.assignment.create_btn') }}</x-ds.button>
                </x-lms-form-actions>
            </form>
        </x-lms-form-card>
    </div>
