<x-guest-layout>
    ...
    <x-lms-public-shell centered>
        ...
        <p class="lms-error-code" style="background: linear-gradient(135deg, #dc2626, #ef4444); -webkit-background-clip: text; background-clip: text;">500</p>
        <h1 class="mt-4">{{ __('lms.errors_page.500_title') }}</h1>
