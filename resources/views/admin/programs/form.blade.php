<x-app-layout>
    <style>
        ...
        /* Animasi untuk setiap field (staggered) */
        ...
        .form-group:nth-child(1) { animation-delay: 0.1s; }  /* Program Name */
        .form-group:nth-child(2) { animation-delay: 0.15s; } /* Description */
        .form-group:nth-child(3) { animation-delay: 0.2s; }  /* Start Date */
        .form-group:nth-child(4) { animation-delay: 0.25s; } /* End Date */
        .form-group:nth-child(5) { animation-delay: 0.3s; }  /* Status */
        .form-group:nth-child(6) { animation-delay: 0.35s; } /* Capacity */
