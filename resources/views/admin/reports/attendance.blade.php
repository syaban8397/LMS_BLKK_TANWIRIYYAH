                        ...
                        <tr class="hover:bg-slate-50">
                            ...
                            <td class="px-4 py-3 text-center">
                                <a href="{{ route('admin.reports.attendance.show', $class) }}"
                                   class="px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-xs font-medium">Lihat Rekap</a>
                            </td>
                        </tr>
                    @empty
                        <tr><td colspan="4" class="py-10 text-center text-slate-400">Belum ada kelas.</td></tr>
                    @endforelse
                </tbody>
            </table>
            @if($classes->hasPages())
