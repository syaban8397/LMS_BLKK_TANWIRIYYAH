    ...
    <div class="space-y-5">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div>
                ...
                <p class="text-sm text-slate-500 mt-0.5">Update class information.</p>
            </div>
            <div class="hidden md:flex items-center gap-1 px-3 py-1 bg-amber-100 text-amber-700 rounded-lg text-xs shadow-sm">
                ✏️ Edit Mode
            </div>
        </div>
